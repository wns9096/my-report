...
### 제안서 (임시 탭) — 자동 절과 사람 절이 배지로 갈린다

![제안서](docs/shots/3_proposal.png)

### 제안서 · 적용 — 후보는 자동, 고르는 것은 사람

![적용](docs/shots/3_proposal_human.png)
...
| `w9d2_proposal.py` | 9주차 Day2 — 자동 절과 사람 절이 코드로 갈렸는가 · 자동 절의 숫자가 전부 카드에 있는가 (28항목) |
...
├── CLAUDE.md                ★ 이 앱에서 지킬 것 열일곱 — 다음 프로젝트로 그대로 간다
├── core/
...
├── screens/                   화면 넷. 파일 이름은 ASCII, 메뉴 이름은 우리말
├── viz/charts.py            차트. 색은 config.COLORS 에서만 가져온다
├── report/
│   ├── sections.py          8장 조립 · 금지어 · check_phrasing
│   ├── proposal.py          ★ 9주차 — 제안서 7절 조립. 절마다 kind=auto|human
...
├── 제안카드.md              ★ 9주차 Day2 — 제안 카드 3장. **제안서의 원본이다**
