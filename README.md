...
| `w9d4_answers.py` | 9주차 Day4 — 답변지에 «고쳤다»고 적은 27건(페르소나 13 · 강사 벤치마크 14)이 지금 문서에 실제로 있는가 · **사람이 손으로 쓴 숫자 13개**를 다시 세서 견줌 · 답변지에 «안 고친 것»이 하나라도 있는가 |
...
├── 제안서_답변지.md         ★ 9주차 Day4 — 받은 지적을 셋으로 가른 표 두 벌(페르소나 · 벤치마크) + **안 고친 것과 이유 8건**
